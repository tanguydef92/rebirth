...
import math
import numpy as np
# Compatibility shim for older dependencies that reference deprecated numpy aliases (np.float, np.int)
# These aliases were removed in recent NumPy; set them to safe builtin types if missing.
